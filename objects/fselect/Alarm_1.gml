if start.mycan=1{
instance_create(x+20,y+32,fsprpy)
instance_create(x+288,y+40,msthp)
while string_length(strs)>0{
if ord(strs)>64 && ord(strs)<91 && frac(vuuu/time)=0 then{
  a=instance_create(x+gu*16+68,y+36+gn*32,wds6)
...
else if ord(strs)=45 && frac(vuuu/time)=0 then{
  a=instance_create(x+gu*16+68,y+36+gn*32,wds6)
  a.image_index=63
  gu+=1
  strs=string_delete(strs,1,1)
}
else if ord(strs)=48 && frac(vuuu/time)=0 then{
  a=instance_create(x+gu*16+68,y+36+gn*32,wds6)
  a.image_index=64
  gu+=1
  strs=string_delete(strs,1,1)
