...
if pm = true{
  switch pis{
    case 1: jk = vk_left; break;
    case 2: jk = vk_up; break;
    case 3: jk = vk_down; break;
    case 4: jk = vk_right; break;
  }
  xj = 0;
}else{
  jk = vk_up;
...
if bt = true || pm = true{
  if a>0{
    sprite_index=bssp324
    a-=1
  }
  if a=0{
    sprite_index=bssp323
  }
  image_angle=0
...
if sg > 0 then repeat sg {
  switch sgd{
    case 1: if !place_meeting(x+1,y,bk22) then x+=1 else {sg = 0;sgd = 0;} break;
    case 2: if !place_meeting(x,y-1,bk22) then y-=1 else {sg = 0;sgd = 0;} break;
    case 3: if !place_meeting(x-1,y,bk22) then x-=1 else {sg = 0;sgd = 0;} break;
    case 4: if !place_meeting(x,y+1,bk22) then y+=1 else {sg = 0;sgd = 0;} break;
  }
}
