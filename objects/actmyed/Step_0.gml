...
if keyboard_check_pressed(vk_enter) && string_length(strs)=0 && plpa=0 && v=1{
  au=instance_create(x,y,myselend)
  au.strs="* YOU WON!/* You earned 0 XP and 0 gold"
  au.time=2
  (start.boss).image_alpha=0.5
  (start.boss).image_speed=0
  (start.boss).myed=1
  instance_destroy()
  with(wds5){
    instance_destroy()
